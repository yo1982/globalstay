...
export const BuildingIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m-1 4h1m5-8h1m-1 4h1m-1 4h1M9 21v-3.07a2 2 0 01.684-1.5l1.316-.922a2 2 0 00.684-1.5V9a2 2 0 012-2h1a2 2 0 012 2v2.008a2 2 0 00.684 1.5l1.316.922a2 2 0 01.684 1.5V21" />
  </svg>
);
...
export const WifiIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.111 16.556A5.5 5.5 0 0112 15c1.455 0 2.805.54 3.889 1.556M12 21h.01M4.878 12.354a10.001 10.001 0 0114.244 0" /></svg>
);
export const PoolIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h1a2 2 0 002-2v-1a2 2 0 012-2h1.945M10 16h4M10 11a2 2 0 114 0v1a2 2 0 11-4 0v-1z" /></svg>
);
export const RestaurantIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 21v-8m0 0V5a2 2 0 012-2h4a2 2 0 012 2v4a2 2 0 01-2 2h-4a2 2 0 01-2-2zM12 21v-8m0 0H8a2 2 0 01-2-2V5a2 2 0 012-2h4a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2z" /></svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L11 11l-2.293-2.293a1 1 0 010-1.414L11 5zM17 3l-2.293 2.293a1 1 0 000 1.414L17 11l2.293-2.293a1 1 0 000-1.414L17 3zm-9.293 9.293L3 17v2h2l4.293-4.293a1 1 0 00-1.414-1.414z" /></svg>
);

export const GlobeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h1a2 2 0 002-2v-1a2 2 0 012-2h1.945M12 21a9 9 0 100-18 9 9 0 000 18z" /></svg>
);
export const TagIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 7h.01M7 3h5a2 2 0 012 2v5a2 2 0 01-2 2H7a2 2 0 01-2-2V5a2 2 0 012-2zM12 12l-4.293 4.293a1 1 0 000 1.414l.001.001.001.001a1 1 0 001.414 0L12 13.414l4.293 4.293a1 1 0 001.414 0l.001-.001.001-.001a1 1 0 000-1.414L13.414 12l4.293-4.293a1 1 0 000-1.414l-.001-.001-.001-.001a1 1 0 00-1.414 0L12 10.586 7.707 6.293a1 1 0 00-1.414 0l-.001.001-.001.001a1 1 0 000 1.414L10.586 12z" /></svg>
);
